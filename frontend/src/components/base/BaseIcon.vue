<!--
  ...
  A flexible icon component that renders SVG icons from a predefined set.
  Supports various sizes and colors, with full dark mode compatibility.
  
  @props {String} name - Name of the icon to display
  @props {String} size - Size of the icon (xs, sm, md, lg, xl)
  @props {String} color - Color override for the icon
  
  @example
  <BaseIcon name="refresh" size="md" />
-->
...
const props = defineProps({
  ...
  strokeLinejoin: {
    type: String,
    default: 'round',
    validator: (value) => ['round', 'miter', 'bevel'].includes(value)
  }
});
...
const iconPath = computed(() => {
  ...
  const icons = {
    ...
    // Project specific
    'tool': 'M10.5 3.75a6.75 6.75 0 100 13.5 6.75 6.75 0 000-13.5zM2.25 10.5h1.5m13.5 0h1.5M4.875 15.75l1.06-1.06m12.125 0l-1.06-1.06M4.875 5.25l1.06 1.06m12.125 0l-1.06 1.06m-8.19 5.44a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm4.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z',
