<template>
  <div class="work-types-list">
    ...
    <div
      ...
      class="p-6 text-center bg-gray-50 dark:bg-gray-800 rounded-lg"
    >
      <div class="text-gray-500 dark:text-gray-400">
        ...
        <p class="text-lg font-medium">No work types found</p>
        <p class="mt-1">Add a new work type or adjust your filters</p>
      </div>
    </div>
