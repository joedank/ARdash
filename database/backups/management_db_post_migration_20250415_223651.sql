...
CREATE TABLE public.communities (
    ...
    phone character varying(255),
    spaces integer,
    ad_specialist_name character varying(255),
    ad_specialist_email character varying(255),
    ad_specialist_phone character varying(255),
    selected_ad_type_id integer,
    newsletter_link character varying(255),
    general_notes text,
...
COPY public.communities (id, name, address, city, state, phone, spaces, ad_specialist_name, ad_specialist_email, ad_specialist_phone, selected_ad_type_id, newsletter_link, general_notes, is_active, created_at, updated_at) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.ad_types_id_seq', 1, false);
...
--
-- Name: ad_types ad_types_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
